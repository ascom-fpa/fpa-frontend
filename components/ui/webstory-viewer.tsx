      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 overflow-hidden">
          <div className="absolute inset-0 flex items-center justify-center">
            <Dialog.Panel className="relative w-full h-full max-w-[450px] bg-black">
              <button
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="w-full h-full relative">
                    ...
                    {/* Texto sobre a imagem com atraso */}
                    {webstory.slides[index].text && (
                      <motion.div
                        initial={{ opacity: 0, y: 10 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ delay: 0.3, duration: 0.5 }}
                        className="absolute bottom-6 left-4 right-4 text-white text-lg font-medium bg-black/50 px-4 py-2 rounded-lg max-w-[85%]"
                      >
                        {webstory.slides[index].text}
                      </motion.div>
                    )}
